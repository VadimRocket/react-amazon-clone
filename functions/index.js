...
const { request, response } = require('express');
                             // secret key 
const stripe = require('stripe')('sk_test_51HQ4A1Hbpicdl2H0PByYYqaE7Azyk9Qk2R62uwBLrMUgzy8dfIZQIS7Q1hPFJbzHXgZBSmXqmtyruwKVeY6UJEQW00q2u7NYZA');
...
// API ROUTES
// root endpoint
app.get('/', (request, response) => response.status(200).send('Hi root Endpoint'));
